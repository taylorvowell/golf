...
priority: 90
citations: ["vercel:react-best-practices — rule async-parallel", "vercel:react-best-practices — rule server-parallel-fetching", "vercel:react-best-practices — rule server-cache-react"]
maxBriefChars: 850
---
