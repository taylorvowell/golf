...
5. **Defer all third-party JS post-hydration.** Analytics, chat widgets, marketing pixels, cookie banners. None of them block the LCP. Cite `vercel:react-best-practices — rule bundle-defer-third-party`.
...
- `vercel:react-best-practices — rule bundle-defer-third-party` — defer analytics/pixels
