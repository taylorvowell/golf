...
- **Prerequisite reading:** the D51 Skia measurement — freeform stroke rendering during
  recording and replay is its second consumer; take the reading before step 01.
- **First HANDOFF rows:** a second test account (no coach exists in any seeded
  environment) and a recorded-on-device lesson fixture.
- **Track-start strategic decision:** the transcript (speech-to-text) vendor — user voice
  data reaches a vendor, so it is a logged vendor choice, not a tactical pick.
