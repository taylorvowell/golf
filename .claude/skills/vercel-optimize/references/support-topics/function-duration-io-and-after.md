...
priority: 75
citations: ["https://nextjs.org/docs/app/api-reference/functions/after", "vercel:react-best-practices — rule async-parallel", "vercel:react-best-practices — rule server-after-nonblocking"]
maxBriefChars: 850
---
