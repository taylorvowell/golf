...
priority: 70
citations: ["https://react.dev/reference/react/cache", "vercel:react-best-practices — rule server-parallel-fetching", "vercel:react-best-practices — rule server-cache-react"]
maxBriefChars: 850
---
