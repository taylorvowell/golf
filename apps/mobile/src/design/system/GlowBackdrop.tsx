      ...
      >
        <Defs>
          <RadialGradient id="glow-aqua" cx="50%" cy="50%" r="50%">
            <Stop offset="0" stopColor="#2DF0FB" stopOpacity={0.13} />
            <Stop offset="0.66" stopColor="#2DF0FB" stopOpacity={0} />
          </RadialGradient>
        </Defs>
      ...
      >
        <Defs>
          <RadialGradient id="glow-cobalt" cx="50%" cy="50%" r="50%">
            <Stop offset="0" stopColor="#0D94DB" stopOpacity={0.16} />
            <Stop offset="0.7" stopColor="#0D94DB" stopOpacity={0} />
          </RadialGradient>
        </Defs>
