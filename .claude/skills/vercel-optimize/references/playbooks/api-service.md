...
- `vercel:react-best-practices — rule async-parallel` — parallelize external API calls
- `vercel:react-best-practices — rule server-after-nonblocking` — `after()` for post-response work
